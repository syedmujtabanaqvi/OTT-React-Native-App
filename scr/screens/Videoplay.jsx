...
export default function Videoplay() {
    ...
    return (
        ...
        <View style={{ flex: 1, backgroundColor: 'black' }}>
            <Image style={styles.image1} source={{ uri: 'https://media.istockphoto.com/id/1252447446/vector/video-player-screen-with-bar-multimedia-interface-with-player-bar-for-web.jpg?s=612x612&w=0&k=20&c=7ydoT5M3SouYSP5YADAz6aoCnDjwQTijhi4HhDMUwqg=' }}></Image>
